  ...
  return (
    <MotionHighlightItem value={index.toString()} className="size-full">
      <TabPrimitive
        ...
        className={cn(
          'ring-offset-background focus-visible:ring-ring data-selected:text-foreground z-[1] inline-flex size-full cursor-pointer items-center justify-center rounded-sm px-2 py-1 text-sm font-medium whitespace-nowrap transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
          className,
        )}
...
function TabPanel<TTag extends React.ElementType = typeof motion.div>(props: TabPanelProps<TTag>) {
  const {
    className,
    as = motion.div,
    transition = {
