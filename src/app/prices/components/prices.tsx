export default function Prices() {
  return (
    <div className="relative isolate h-screen bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">
        Escolha um plano acessível que esteja repleto dos melhores recursos para envolver seu
        público, criar fidelidade do cliente e impulsionar as vendas.
      </p>
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
        <div className="rounded-3xl rounded-t-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-tr-none lg:rounded-bl-3xl">
          ...
          <p className="mt-4 flex items-baseline gap-x-2">
            <span className="text-5xl font-semibold tracking-tight text-gray-900">R$29</span>
          ...
          <ul role="list" className="mt-8 space-y-3 text-sm/6 text-gray-600 sm:mt-10">
            ...
            <li className="flex gap-x-3">
              ...
              10 processos com verificação automática
            </li>
        ...
        <div className="relative rounded-3xl bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
          ...
          <p className="mt-4 flex items-baseline gap-x-2">
            <span className="text-5xl font-semibold tracking-tight text-white">R$99</span>
            <span className="text-base text-gray-400">/mês</span>
          </p>
          <p className="mt-6 text-base/7 text-gray-300">
            Suporte e infraestrutura dedicados para sua empresa.
          </p>
          <ul role="list" className="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
            <li className="flex gap-x-3">
              ...
              Número ilimitado de consultas diárias
            </li>
            <li className="flex gap-x-3">
              <svg
                className="h-6 w-5 flex-none text-indigo-400"
              ...
              100 processos com verificação automática
            </li>
