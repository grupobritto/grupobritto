            ...
            <div className="flex flex-col items-center">
              ...
              <div className="w-full p-6 text-center">
                ...
                {loading ? (
                  ...
                  <h1 className="text-2xl font-bold tracking-widest text-(--jose) uppercase dark:text-(--jose)">
                    José de Britto
                  </h1>
                )}
                ...
                {loading ? (
                  ...
                  <p className="mb-5 text-sm text-neutral-500 dark:text-neutral-400">Estudante</p>
                )}
                  ...
                  {loading ? (
                    ...
                    <>
                      <div className="flex items-center gap-2">
                        <Phone className="size-5 text-(--jose) dark:text-(--jose)" />
                        (48) 984 711 709
                      </div>
                      <div className="flex items-center gap-2">
                        <Mail className="size-5 text-(--jose) dark:text-(--jose)" />
                        jose@grupobritto.com.br
                      </div>
                      <div className="flex items-center gap-2">
                        <MapPinned className="size-5 text-(--jose) dark:text-(--jose)" />
                  ...
                  {loading ? (
                    ...
                    <>
                      <a
                        ...
                        className="text-(--jose) transition hover:text-(--jose-hover) dark:text-(--jose) dark:hover:text-(--jose-hover)"
                      >
